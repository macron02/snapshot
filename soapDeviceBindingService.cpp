...
static int serve___tds__SetHashingAlgorithm(struct soap*, DeviceBindingService*);
...
int DeviceBindingService::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "tds:SetHashingAlgorithm"))
		return serve___tds__SetHashingAlgorithm(soap, this);
...
static int serve___tds__SetHashingAlgorithm(struct soap *soap, DeviceBindingService *service)
{	struct __tds__SetHashingAlgorithm soap_tmp___tds__SetHashingAlgorithm;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->SetHashingAlgorithm(soap_tmp___tds__SetHashingAlgorithm.tds__SetHashingAlgorithm, tds__SetHashingAlgorithmResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
