...
#include "soapH.h"
    ...
    class SOAP_CMAC DeviceBindingService {
      public:
        ...
        //
        /// Web service operation 'SetHashingAlgorithm' implementation, should return SOAP_OK or error code
        virtual int SetHashingAlgorithm(_tds__SetHashingAlgorithm *tds__SetHashingAlgorithm, _tds__SetHashingAlgorithmResponse &tds__SetHashingAlgorithmResponse) SOAP_PURE_VIRTUAL;
    };
#endif
