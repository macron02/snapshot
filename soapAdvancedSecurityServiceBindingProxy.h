/* soapAdvancedSecurityServiceBindingProxy.h
   Generated by gSOAP 2.8.135 for onvif.h
...
#include "soapH.h"
    ...
    class SOAP_CMAC AdvancedSecurityServiceBindingProxy {
      public:
        ...
        //
        /// Web service synchronous operation 'GetJWTConfiguration' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int GetJWTConfiguration(_tas__GetJWTConfiguration *tas__GetJWTConfiguration, _tas__GetJWTConfigurationResponse &tas__GetJWTConfigurationResponse) { return this->GetJWTConfiguration(NULL, NULL, tas__GetJWTConfiguration, tas__GetJWTConfigurationResponse); }
        /// Web service synchronous operation 'GetJWTConfiguration' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int GetJWTConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__GetJWTConfiguration *tas__GetJWTConfiguration, _tas__GetJWTConfigurationResponse &tas__GetJWTConfigurationResponse) { return this->send_GetJWTConfiguration(soap_endpoint_url, soap_action, tas__GetJWTConfiguration) || this->recv_GetJWTConfiguration(tas__GetJWTConfigurationResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_GetJWTConfiguration' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_GetJWTConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__GetJWTConfiguration *tas__GetJWTConfiguration);
        /// Web service asynchronous operation 'recv_GetJWTConfiguration' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_GetJWTConfiguration(_tas__GetJWTConfigurationResponse &tas__GetJWTConfigurationResponse);
        //
        /// Web service synchronous operation 'SetJWTConfiguration' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int SetJWTConfiguration(_tas__SetJWTConfiguration *tas__SetJWTConfiguration, _tas__SetJWTConfigurationResponse &tas__SetJWTConfigurationResponse) { return this->SetJWTConfiguration(NULL, NULL, tas__SetJWTConfiguration, tas__SetJWTConfigurationResponse); }
        /// Web service synchronous operation 'SetJWTConfiguration' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int SetJWTConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__SetJWTConfiguration *tas__SetJWTConfiguration, _tas__SetJWTConfigurationResponse &tas__SetJWTConfigurationResponse) { return this->send_SetJWTConfiguration(soap_endpoint_url, soap_action, tas__SetJWTConfiguration) || this->recv_SetJWTConfiguration(tas__SetJWTConfigurationResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_SetJWTConfiguration' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_SetJWTConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__SetJWTConfiguration *tas__SetJWTConfiguration);
        /// Web service asynchronous operation 'recv_SetJWTConfiguration' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_SetJWTConfiguration(_tas__SetJWTConfigurationResponse &tas__SetJWTConfigurationResponse);
        //
        ...
        //
        /// Web service synchronous operation 'CreateECCKeyPair' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int CreateECCKeyPair(_tas__CreateECCKeyPair *tas__CreateECCKeyPair, _tas__CreateECCKeyPairResponse &tas__CreateECCKeyPairResponse) { return this->CreateECCKeyPair(NULL, NULL, tas__CreateECCKeyPair, tas__CreateECCKeyPairResponse); }
        /// Web service synchronous operation 'CreateECCKeyPair' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int CreateECCKeyPair(const char *soap_endpoint_url, const char *soap_action, _tas__CreateECCKeyPair *tas__CreateECCKeyPair, _tas__CreateECCKeyPairResponse &tas__CreateECCKeyPairResponse) { return this->send_CreateECCKeyPair(soap_endpoint_url, soap_action, tas__CreateECCKeyPair) || this->recv_CreateECCKeyPair(tas__CreateECCKeyPairResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_CreateECCKeyPair' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_CreateECCKeyPair(const char *soap_endpoint_url, const char *soap_action, _tas__CreateECCKeyPair *tas__CreateECCKeyPair);
        /// Web service asynchronous operation 'recv_CreateECCKeyPair' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_CreateECCKeyPair(_tas__CreateECCKeyPairResponse &tas__CreateECCKeyPairResponse);
        //
        ...
        //
        /// Web service synchronous operation 'GetAuthorizationServerConfigurations' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int GetAuthorizationServerConfigurations(_tas__GetAuthorizationServerConfigurations *tas__GetAuthorizationServerConfigurations, _tas__GetAuthorizationServerConfigurationsResponse &tas__GetAuthorizationServerConfigurationsResponse) { return this->GetAuthorizationServerConfigurations(NULL, NULL, tas__GetAuthorizationServerConfigurations, tas__GetAuthorizationServerConfigurationsResponse); }
        /// Web service synchronous operation 'GetAuthorizationServerConfigurations' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int GetAuthorizationServerConfigurations(const char *soap_endpoint_url, const char *soap_action, _tas__GetAuthorizationServerConfigurations *tas__GetAuthorizationServerConfigurations, _tas__GetAuthorizationServerConfigurationsResponse &tas__GetAuthorizationServerConfigurationsResponse) { return this->send_GetAuthorizationServerConfigurations(soap_endpoint_url, soap_action, tas__GetAuthorizationServerConfigurations) || this->recv_GetAuthorizationServerConfigurations(tas__GetAuthorizationServerConfigurationsResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_GetAuthorizationServerConfigurations' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_GetAuthorizationServerConfigurations(const char *soap_endpoint_url, const char *soap_action, _tas__GetAuthorizationServerConfigurations *tas__GetAuthorizationServerConfigurations);
        /// Web service asynchronous operation 'recv_GetAuthorizationServerConfigurations' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_GetAuthorizationServerConfigurations(_tas__GetAuthorizationServerConfigurationsResponse &tas__GetAuthorizationServerConfigurationsResponse);
        //
        /// Web service synchronous operation 'CreateAuthorizationServerConfiguration' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int CreateAuthorizationServerConfiguration(_tas__CreateAuthorizationServerConfiguration *tas__CreateAuthorizationServerConfiguration, _tas__CreateAuthorizationServerConfigurationResponse &tas__CreateAuthorizationServerConfigurationResponse) { return this->CreateAuthorizationServerConfiguration(NULL, NULL, tas__CreateAuthorizationServerConfiguration, tas__CreateAuthorizationServerConfigurationResponse); }
        /// Web service synchronous operation 'CreateAuthorizationServerConfiguration' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int CreateAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__CreateAuthorizationServerConfiguration *tas__CreateAuthorizationServerConfiguration, _tas__CreateAuthorizationServerConfigurationResponse &tas__CreateAuthorizationServerConfigurationResponse) { return this->send_CreateAuthorizationServerConfiguration(soap_endpoint_url, soap_action, tas__CreateAuthorizationServerConfiguration) || this->recv_CreateAuthorizationServerConfiguration(tas__CreateAuthorizationServerConfigurationResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_CreateAuthorizationServerConfiguration' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_CreateAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__CreateAuthorizationServerConfiguration *tas__CreateAuthorizationServerConfiguration);
        /// Web service asynchronous operation 'recv_CreateAuthorizationServerConfiguration' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_CreateAuthorizationServerConfiguration(_tas__CreateAuthorizationServerConfigurationResponse &tas__CreateAuthorizationServerConfigurationResponse);
        //
        /// Web service synchronous operation 'SetAuthorizationServerConfiguration' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int SetAuthorizationServerConfiguration(_tas__SetAuthorizationServerConfiguration *tas__SetAuthorizationServerConfiguration, _tas__SetAuthorizationServerConfigurationResponse &tas__SetAuthorizationServerConfigurationResponse) { return this->SetAuthorizationServerConfiguration(NULL, NULL, tas__SetAuthorizationServerConfiguration, tas__SetAuthorizationServerConfigurationResponse); }
        /// Web service synchronous operation 'SetAuthorizationServerConfiguration' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int SetAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__SetAuthorizationServerConfiguration *tas__SetAuthorizationServerConfiguration, _tas__SetAuthorizationServerConfigurationResponse &tas__SetAuthorizationServerConfigurationResponse) { return this->send_SetAuthorizationServerConfiguration(soap_endpoint_url, soap_action, tas__SetAuthorizationServerConfiguration) || this->recv_SetAuthorizationServerConfiguration(tas__SetAuthorizationServerConfigurationResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_SetAuthorizationServerConfiguration' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_SetAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__SetAuthorizationServerConfiguration *tas__SetAuthorizationServerConfiguration);
        /// Web service asynchronous operation 'recv_SetAuthorizationServerConfiguration' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_SetAuthorizationServerConfiguration(_tas__SetAuthorizationServerConfigurationResponse &tas__SetAuthorizationServerConfigurationResponse);
        //
        /// Web service synchronous operation 'DeleteAuthorizationServerConfiguration' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        virtual int DeleteAuthorizationServerConfiguration(_tas__DeleteAuthorizationServerConfiguration *tas__DeleteAuthorizationServerConfiguration, _tas__DeleteAuthorizationServerConfigurationResponse &tas__DeleteAuthorizationServerConfigurationResponse) { return this->DeleteAuthorizationServerConfiguration(NULL, NULL, tas__DeleteAuthorizationServerConfiguration, tas__DeleteAuthorizationServerConfigurationResponse); }
        /// Web service synchronous operation 'DeleteAuthorizationServerConfiguration' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int DeleteAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__DeleteAuthorizationServerConfiguration *tas__DeleteAuthorizationServerConfiguration, _tas__DeleteAuthorizationServerConfigurationResponse &tas__DeleteAuthorizationServerConfigurationResponse) { return this->send_DeleteAuthorizationServerConfiguration(soap_endpoint_url, soap_action, tas__DeleteAuthorizationServerConfiguration) || this->recv_DeleteAuthorizationServerConfiguration(tas__DeleteAuthorizationServerConfigurationResponse) ? this->soap->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_DeleteAuthorizationServerConfiguration' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int send_DeleteAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__DeleteAuthorizationServerConfiguration *tas__DeleteAuthorizationServerConfiguration);
        /// Web service asynchronous operation 'recv_DeleteAuthorizationServerConfiguration' to receive a response message from the connected endpoint, returns SOAP_OK or error code
        virtual int recv_DeleteAuthorizationServerConfiguration(_tas__DeleteAuthorizationServerConfigurationResponse &tas__DeleteAuthorizationServerConfigurationResponse);
    };
#endif
