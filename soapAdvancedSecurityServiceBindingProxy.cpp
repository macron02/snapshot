...
int AdvancedSecurityServiceBindingProxy::send_GetJWTConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__GetJWTConfiguration *tas__GetJWTConfiguration)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__GetJWTConfiguration(soap, &soap_tmp___tas__GetJWTConfiguration, "-tas:GetJWTConfiguration", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_GetJWTConfiguration(_tas__GetJWTConfigurationResponse &tas__GetJWTConfigurationResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__GetJWTConfigurationResponse.soap_get(soap, "tas:GetJWTConfigurationResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_SetJWTConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__SetJWTConfiguration *tas__SetJWTConfiguration)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__SetJWTConfiguration(soap, &soap_tmp___tas__SetJWTConfiguration, "-tas:SetJWTConfiguration", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_SetJWTConfiguration(_tas__SetJWTConfigurationResponse &tas__SetJWTConfigurationResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__SetJWTConfigurationResponse.soap_get(soap, "tas:SetJWTConfigurationResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_CreateECCKeyPair(const char *soap_endpoint_url, const char *soap_action, _tas__CreateECCKeyPair *tas__CreateECCKeyPair)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__CreateECCKeyPair(soap, &soap_tmp___tas__CreateECCKeyPair, "-tas:CreateECCKeyPair", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_CreateECCKeyPair(_tas__CreateECCKeyPairResponse &tas__CreateECCKeyPairResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__CreateECCKeyPairResponse.soap_get(soap, "tas:CreateECCKeyPairResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_GetAuthorizationServerConfigurations(const char *soap_endpoint_url, const char *soap_action, _tas__GetAuthorizationServerConfigurations *tas__GetAuthorizationServerConfigurations)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__GetAuthorizationServerConfigurations(soap, &soap_tmp___tas__GetAuthorizationServerConfigurations, "-tas:GetAuthorizationServerConfigurations", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_GetAuthorizationServerConfigurations(_tas__GetAuthorizationServerConfigurationsResponse &tas__GetAuthorizationServerConfigurationsResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__GetAuthorizationServerConfigurationsResponse.soap_get(soap, "tas:GetAuthorizationServerConfigurationsResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_CreateAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__CreateAuthorizationServerConfiguration *tas__CreateAuthorizationServerConfiguration)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__CreateAuthorizationServerConfiguration(soap, &soap_tmp___tas__CreateAuthorizationServerConfiguration, "-tas:CreateAuthorizationServerConfiguration", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_CreateAuthorizationServerConfiguration(_tas__CreateAuthorizationServerConfigurationResponse &tas__CreateAuthorizationServerConfigurationResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__CreateAuthorizationServerConfigurationResponse.soap_get(soap, "tas:CreateAuthorizationServerConfigurationResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_SetAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__SetAuthorizationServerConfiguration *tas__SetAuthorizationServerConfiguration)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__SetAuthorizationServerConfiguration(soap, &soap_tmp___tas__SetAuthorizationServerConfiguration, "-tas:SetAuthorizationServerConfiguration", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_SetAuthorizationServerConfiguration(_tas__SetAuthorizationServerConfigurationResponse &tas__SetAuthorizationServerConfigurationResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__SetAuthorizationServerConfigurationResponse.soap_get(soap, "tas:SetAuthorizationServerConfigurationResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int AdvancedSecurityServiceBindingProxy::send_DeleteAuthorizationServerConfiguration(const char *soap_endpoint_url, const char *soap_action, _tas__DeleteAuthorizationServerConfiguration *tas__DeleteAuthorizationServerConfiguration)
{
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tas__DeleteAuthorizationServerConfiguration(soap, &soap_tmp___tas__DeleteAuthorizationServerConfiguration, "-tas:DeleteAuthorizationServerConfiguration", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int AdvancedSecurityServiceBindingProxy::recv_DeleteAuthorizationServerConfiguration(_tas__DeleteAuthorizationServerConfigurationResponse &tas__DeleteAuthorizationServerConfigurationResponse)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tas__DeleteAuthorizationServerConfigurationResponse.soap_get(soap, "tas:DeleteAuthorizationServerConfigurationResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
