...
static int serve___tas__GetJWTConfiguration(struct soap*, AdvancedSecurityServiceBindingService*);
static int serve___tas__SetJWTConfiguration(struct soap*, AdvancedSecurityServiceBindingService*);
static int serve___tas__CreateRSAKeyPair(struct soap*, AdvancedSecurityServiceBindingService*);
static int serve___tas__CreateECCKeyPair(struct soap*, AdvancedSecurityServiceBindingService*);
...
static int serve___tas__GetAuthorizationServerConfigurations(struct soap*, AdvancedSecurityServiceBindingService*);
static int serve___tas__CreateAuthorizationServerConfiguration(struct soap*, AdvancedSecurityServiceBindingService*);
static int serve___tas__SetAuthorizationServerConfiguration(struct soap*, AdvancedSecurityServiceBindingService*);
static int serve___tas__DeleteAuthorizationServerConfiguration(struct soap*, AdvancedSecurityServiceBindingService*);
...
int AdvancedSecurityServiceBindingService::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "tas:GetJWTConfiguration"))
		return serve___tas__GetJWTConfiguration(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tas:SetJWTConfiguration"))
		return serve___tas__SetJWTConfiguration(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tas:CreateRSAKeyPair"))
		return serve___tas__CreateRSAKeyPair(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tas:CreateECCKeyPair"))
		return serve___tas__CreateECCKeyPair(soap, this);
	...
	if (!soap_match_tag(soap, soap->tag, "tas:GetAuthorizationServerConfigurations"))
		return serve___tas__GetAuthorizationServerConfigurations(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tas:CreateAuthorizationServerConfiguration"))
		return serve___tas__CreateAuthorizationServerConfiguration(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tas:SetAuthorizationServerConfiguration"))
		return serve___tas__SetAuthorizationServerConfiguration(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tas:DeleteAuthorizationServerConfiguration"))
		return serve___tas__DeleteAuthorizationServerConfiguration(soap, this);
...
static int serve___tas__GetJWTConfiguration(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__GetJWTConfiguration soap_tmp___tas__GetJWTConfiguration;
	_tas__GetJWTConfigurationResponse tas__GetJWTConfigurationResponse;
	tas__GetJWTConfigurationResponse.soap_default(soap);
	soap_default___tas__GetJWTConfiguration(soap, &soap_tmp___tas__GetJWTConfiguration);
	if (!soap_get___tas__GetJWTConfiguration(soap, &soap_tmp___tas__GetJWTConfiguration, "-tas:GetJWTConfiguration", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetJWTConfiguration(soap_tmp___tas__GetJWTConfiguration.tas__GetJWTConfiguration, tas__GetJWTConfigurationResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__GetJWTConfigurationResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__GetJWTConfigurationResponse.soap_put(soap, "tas:GetJWTConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___tas__SetJWTConfiguration(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__SetJWTConfiguration soap_tmp___tas__SetJWTConfiguration;
	_tas__SetJWTConfigurationResponse tas__SetJWTConfigurationResponse;
	tas__SetJWTConfigurationResponse.soap_default(soap);
	soap_default___tas__SetJWTConfiguration(soap, &soap_tmp___tas__SetJWTConfiguration);
	if (!soap_get___tas__SetJWTConfiguration(soap, &soap_tmp___tas__SetJWTConfiguration, "-tas:SetJWTConfiguration", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->SetJWTConfiguration(soap_tmp___tas__SetJWTConfiguration.tas__SetJWTConfiguration, tas__SetJWTConfigurationResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__SetJWTConfigurationResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__SetJWTConfigurationResponse.soap_put(soap, "tas:SetJWTConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___tas__CreateECCKeyPair(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__CreateECCKeyPair soap_tmp___tas__CreateECCKeyPair;
	_tas__CreateECCKeyPairResponse tas__CreateECCKeyPairResponse;
	tas__CreateECCKeyPairResponse.soap_default(soap);
	soap_default___tas__CreateECCKeyPair(soap, &soap_tmp___tas__CreateECCKeyPair);
	if (!soap_get___tas__CreateECCKeyPair(soap, &soap_tmp___tas__CreateECCKeyPair, "-tas:CreateECCKeyPair", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->CreateECCKeyPair(soap_tmp___tas__CreateECCKeyPair.tas__CreateECCKeyPair, tas__CreateECCKeyPairResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__CreateECCKeyPairResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__CreateECCKeyPairResponse.soap_put(soap, "tas:CreateECCKeyPairResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___tas__GetAuthorizationServerConfigurations(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__GetAuthorizationServerConfigurations soap_tmp___tas__GetAuthorizationServerConfigurations;
	_tas__GetAuthorizationServerConfigurationsResponse tas__GetAuthorizationServerConfigurationsResponse;
	tas__GetAuthorizationServerConfigurationsResponse.soap_default(soap);
	soap_default___tas__GetAuthorizationServerConfigurations(soap, &soap_tmp___tas__GetAuthorizationServerConfigurations);
	if (!soap_get___tas__GetAuthorizationServerConfigurations(soap, &soap_tmp___tas__GetAuthorizationServerConfigurations, "-tas:GetAuthorizationServerConfigurations", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetAuthorizationServerConfigurations(soap_tmp___tas__GetAuthorizationServerConfigurations.tas__GetAuthorizationServerConfigurations, tas__GetAuthorizationServerConfigurationsResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__GetAuthorizationServerConfigurationsResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__GetAuthorizationServerConfigurationsResponse.soap_put(soap, "tas:GetAuthorizationServerConfigurationsResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___tas__CreateAuthorizationServerConfiguration(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__CreateAuthorizationServerConfiguration soap_tmp___tas__CreateAuthorizationServerConfiguration;
	_tas__CreateAuthorizationServerConfigurationResponse tas__CreateAuthorizationServerConfigurationResponse;
	tas__CreateAuthorizationServerConfigurationResponse.soap_default(soap);
	soap_default___tas__CreateAuthorizationServerConfiguration(soap, &soap_tmp___tas__CreateAuthorizationServerConfiguration);
	if (!soap_get___tas__CreateAuthorizationServerConfiguration(soap, &soap_tmp___tas__CreateAuthorizationServerConfiguration, "-tas:CreateAuthorizationServerConfiguration", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->CreateAuthorizationServerConfiguration(soap_tmp___tas__CreateAuthorizationServerConfiguration.tas__CreateAuthorizationServerConfiguration, tas__CreateAuthorizationServerConfigurationResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__CreateAuthorizationServerConfigurationResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__CreateAuthorizationServerConfigurationResponse.soap_put(soap, "tas:CreateAuthorizationServerConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___tas__SetAuthorizationServerConfiguration(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__SetAuthorizationServerConfiguration soap_tmp___tas__SetAuthorizationServerConfiguration;
	_tas__SetAuthorizationServerConfigurationResponse tas__SetAuthorizationServerConfigurationResponse;
	tas__SetAuthorizationServerConfigurationResponse.soap_default(soap);
	soap_default___tas__SetAuthorizationServerConfiguration(soap, &soap_tmp___tas__SetAuthorizationServerConfiguration);
	if (!soap_get___tas__SetAuthorizationServerConfiguration(soap, &soap_tmp___tas__SetAuthorizationServerConfiguration, "-tas:SetAuthorizationServerConfiguration", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->SetAuthorizationServerConfiguration(soap_tmp___tas__SetAuthorizationServerConfiguration.tas__SetAuthorizationServerConfiguration, tas__SetAuthorizationServerConfigurationResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__SetAuthorizationServerConfigurationResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__SetAuthorizationServerConfigurationResponse.soap_put(soap, "tas:SetAuthorizationServerConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___tas__DeleteAuthorizationServerConfiguration(struct soap *soap, AdvancedSecurityServiceBindingService *service)
{	struct __tas__DeleteAuthorizationServerConfiguration soap_tmp___tas__DeleteAuthorizationServerConfiguration;
	_tas__DeleteAuthorizationServerConfigurationResponse tas__DeleteAuthorizationServerConfigurationResponse;
	tas__DeleteAuthorizationServerConfigurationResponse.soap_default(soap);
	soap_default___tas__DeleteAuthorizationServerConfiguration(soap, &soap_tmp___tas__DeleteAuthorizationServerConfiguration);
	if (!soap_get___tas__DeleteAuthorizationServerConfiguration(soap, &soap_tmp___tas__DeleteAuthorizationServerConfiguration, "-tas:DeleteAuthorizationServerConfiguration", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->DeleteAuthorizationServerConfiguration(soap_tmp___tas__DeleteAuthorizationServerConfiguration.tas__DeleteAuthorizationServerConfiguration, tas__DeleteAuthorizationServerConfigurationResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	tas__DeleteAuthorizationServerConfigurationResponse.soap_serialize(soap);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || tas__DeleteAuthorizationServerConfigurationResponse.soap_put(soap, "tas:DeleteAuthorizationServerConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
